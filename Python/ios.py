        ...
        for assignment in assignments:
            if assignment["due_at"]:
                ...
                if week_start <= due_date <= week_end:
                    ...
                    print(f"{assignment['name']}: {formatted_date}")
...
try:
    ...
    df = pd.DataFrame(columns=['Name', 'Due Date', 'Course'])
        ...
        for assignment in assignments:
            if assignment["due_at"]:
                ...
                if week_start <= due_date <= week_end:
                    ...
                    df = df.append({'Name': assignment['name'], 'Due Date': formatted_date, 'Course': course}, ignore_index=True)
